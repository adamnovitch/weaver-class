...
Starting at 2nd level, your training and connection to the Weave allows you to perform feats and cast spells. As a weaver, your grasp of the weave allows you to bypass the need for material spell components or an arcane focus. However for spell components that have a gold value or consumed materials, you still require the material components. Your access to the Weave is measured in Spell Points. Your number of Spell Points are determined in the class table. They are regained after a long rest.
...
You also get weave powers, which require you to use spell points but are not considered spels. When you level up, you can learn a new spell, up to the spell level denoted in the class table, and can forget one spell you already know and learn a new one. You can have a number of Weave powers up to the number denoted in the class table, and can change which powers you have when you finish a long rest. Unless otherwise noted, all weave powers use your action while in combat.
...
### Force Blast
At 7th level, you can create a invisible blast of magical energy as an action. This blast has a range of 60 feet, and does 2d6 force damage. Roll a ranged spell attack and add your Wisdom modifier and proficiency bonus. On a hit, the target must make a strength saving throw or be pushed back 5 feet. You can spend a maximum of 2 Spell Points, and for each point spent, the damage increases by 1d6 and you can push the enemy back an additional 5 feet. You do not have disadvantage if an enemy is within 5 feet. The maximum Spell points you can spend on this ability increases to 4 at level 11, and 6 at level 15. 
...
| 11th  |                +4 | Force Blast Upgrade             |           11 |           44 |           4 |                  4 |
| 12th  |                +4 | Ability Score Improvement       |           11 |           51 |           5 |                  4 |
| 13th  |                +5 | -                               |           12 |           57 |           5 |                  4 |
| 14th  |                +5 | Path Feature                    |           12 |           64 |           5 |                  5 |
| 15th  |                +5 | Force Blast Upgrade             |           13 |           73 |           6 |                  5 |
...
#### Empowered Strikes
At 6th level, you can use a bonus action before you attack to spend 1 spell point. Your weapon attacks this turn are considered magical for the purpose of overcoming resistance, and deal extra damage equal to your wisdom modifier (minimum 1).
#### Spellstrike
...
At 6th level, when you successfully knock a creature prone using Combat Prowess, you can spend an additional spell point to slam them into the ground, inflicting an additional 1d6 bludgeoning damage. This increases to 2d6 at level 11 and 3d6 at level 17.  
Additionally, when you take the attack action you can spend 2 spell points to use one of the following abilities:
...
At 10th level, you learn the Thunderclap and Word of Radiance cantrips. They are treated as Weaver spells and use your Wisdom as your spellcasting ability for the DC. You can spend 2 spell points when you cast either of these spells, and if you do, and a creature fails the saving throw, they become blinded (Word of Radiance) or deafened (thunderclap) for 1 round.
#### Evasiveness
...
### Spell List
#### Cantrip
- [Friends](https://dnd5e.fandom.com/wiki/Friends )
- [Guidance](https://dnd5e.fandom.com/wiki/Guidance )
- [Mage Hand](https://dnd5e.fandom.com/wiki/Mage_Hand )
- [Message](https://dnd5e.fandom.com/wiki/Message )
- [Resistance](https://dnd5e.fandom.com/wiki/Resistance )
- [Spare the Dying](https://dnd5e.fandom.com/wiki/Spare_the_Dying )
- [Thunderclap](https://dnd5e.fandom.com/wiki/Thunderclap ) (Sentinel Level 10 only)
- [Word of Radiance](https://dnd5e.fandom.com/wiki/Word_of_Radiance ) (Sentinel Level 10 only)

#### 1st Level
- [Absorb Elements](https://dnd5e.fandom.com/wiki/Absorb_Elements )
- [Animal Friendship](https://dnd5e.fandom.com/wiki/Animal_Friendship )
- [Bless](https://dnd5e.fandom.com/wiki/Bless )
- [Catapult](https://dnd5e.fandom.com/wiki/Catapult )
- [Charm Person](https://dnd5e.fandom.com/wiki/Charm_Person )
- [Command](https://dnd5e.fandom.com/wiki/Command )
- [Compelled Duel](https://dnd5e.fandom.com/wiki/Compelled_Duel )
- [Cure Wounds](https://dnd5e.fandom.com/wiki/Cure_Wounds )
- [Detect Evil and Good](https://dnd5e.fandom.com/wiki/Detect_Evil_and_Good )
- [Detect Magic](https://dnd5e.fandom.com/wiki/Detect_Magic )
- [Disguise Self](https://dnd5e.fandom.com/wiki/Disguise_Self )
- [Divine Favor](https://dnd5e.fandom.com/wiki/Divine_Favor )
- [Expeditious Retreat](https://dnd5e.fandom.com/wiki/Expeditious_Retreat )
- [Feather Fall](https://dnd5e.fandom.com/wiki/Feather_Fall )
- [Healing Word](https://dnd5e.fandom.com/wiki/Healing_Word )
- [Jump](https://dnd5e.fandom.com/wiki/Jump )
- [Longstrider](https://dnd5e.fandom.com/wiki/Longstrider )
- [Sanctuary](https://dnd5e.fandom.com/wiki/Sanctuary )
- [Shield](https://dnd5e.fandom.com/wiki/Shield )
- [Shield of Faith](https://dnd5e.fandom.com/wiki/Shield_of_Faith )
- [Thunderwave](https://dnd5e.fandom.com/wiki/Thunderwave )
- [Witch Bolt](https://dnd5e.fandom.com/wiki/Witch_Bolt )
- [Zephyr Strike](https://dnd5e.fandom.com/wiki/Zephyr_Strike )

#### 2nd Level
- [Aid](https://dnd5e.fandom.com/wiki/Aid )
- [Blindness/Deafness](https://dnd5e.fandom.com/wiki/Blindness/Deafness )
- [Blur](https://dnd5e.fandom.com/wiki/Blur )
- [Detect Thoughts](https://dnd5e.fandom.com/wiki/Detect_Thoughts )
- [Enhance Ability](https://dnd5e.fandom.com/wiki/Enhance_Ability )
- [Enlarge](https://dnd5e.fandom.com/wiki/Enlarge/Reduce )
- [Hold Person](https://dnd5e.fandom.com/wiki/Hold_Person )
- [Knock](https://dnd5e.fandom.com/wiki/Knock )
- [Lesser Restoration](https://dnd5e.fandom.com/wiki/Lesser_Restoration )
- [Magic Weapon](https://dnd5e.fandom.com/wiki/Magic_Weapon )
- [Mind Spike](https://dnd5e.fandom.com/wiki/Mind_Spike )
- [Pass Without a Trace](https://dnd5e.fandom.com/wiki/Pass_Without_a_Trace )
- [Purify Food and Drink](https://dnd5e.fandom.com/wiki/Purify_Food_and_Drink )
- [Silence](https://dnd5e.fandom.com/wiki/Silence )
- [Suggestion](https://dnd5e.fandom.com/wiki/Suggestion )
- [Zone of Truth](https://dnd5e.fandom.com/wiki/Zone_of_Truth )

#### 3rd Level
- [Blink](https://dnd5e.fandom.com/wiki/Blink )
- [Counterspell](https://dnd5e.fandom.com/wiki/Counterspell ) (Sage Level 14 only)
- [Haste](https://dnd5e.fandom.com/wiki/Haste )
- [Lightningbolt](https://dnd5e.fandom.com/wiki/Lightningbolt )
- [Life Transferrence](https://dnd5e.fandom.com/wiki/Life_Transferrence )
- [Mass Healing Word](https://dnd5e.fandom.com/wiki/Mass_Healing_Word )
- [Nondetection](https://dnd5e.fandom.com/wiki/Nondetection )
- [Revivify](https://dnd5e.fandom.com/wiki/Revivify )
- [Tongues](https://dnd5e.fandom.com/wiki/Tongues )

#### 4th Level
- [Charm Monster](https://dnd5e.fandom.com/wiki/Charm_Monster )
- [Confusion](https://dnd5e.fandom.com/wiki/Confusion )
- [Death Ward](https://dnd5e.fandom.com/wiki/Death_Ward )
- [Divination](https://dnd5e.fandom.com/wiki/Divination )
- [Dominate Beast](https://dnd5e.fandom.com/wiki/Dominate_Beast )
- [Locate Creature](https://dnd5e.fandom.com/wiki/Locate_Creature )
- [Freedom of Movement](https://dnd5e.fandom.com/wiki/Freedom_of_Movement )

#### 5th Level
- [Greater Restoration](https://dnd5e.fandom.com/wiki/Greater_Restoration )
- [Hold Monster](https://dnd5e.fandom.com/wiki/Hold_Monster )
- [Mass Cure Wounds](https://dnd5e.fandom.com/wiki/Mass_Cure_Wounds )
- [Mislead](https://dnd5e.fandom.com/wiki/Mislead )
- [Scrying](https://dnd5e.fandom.com/wiki/Scrying )
- [Steel Wind Strike](https://dnd5e.fandom.com/wiki/Steel_Wind_Strike )
- [Telekinesis](https://dnd5e.fandom.com/wiki/Telekinesis )

#### 6th Level
- [Chain Lightning](https://dnd5e.fandom.com/wiki/Chain_Lightning )
- [Mass Suggestion](https://dnd5e.fandom.com/wiki/Mass_Suggestion )
- [Tenser's Transformation](https://dnd5e.fandom.com/wiki/Tenser's_Transformation )
- [True Seeing](https://dnd5e.fandom.com/wiki/True_Seeing )
...
By spending 6 Spell points, you can use your bonus action to enter a state similar to the Barbarian's rage. This state lasts for 1 minute and requires concentration, and ends if you lose concentation or go for 1 round without making a weapon attack. While in this state you add half your proficiency bonus (rounded down) to your weapon attack damage rolls, and you resist nonmagical bludgeoning, piercing, and slashing damage. Additionally any existing concentration is broken and you cannot cast spells in this state.  
...
As an action, you can spend 7 spell points and force a target creature within 30 feet make an ability check. Both you and your target make ability checks with your spellcasting ability and add your proficiency bonus. If you win the check, the target cannot cast spells or use spell-like abilities or psionics for 1 minute.  

**Brutal Strike**  
*prerequisite: Level 10*  
As a bonus action before you attack, you can spend 5 spell points and add an extra damage die to your weapon attacks this round.  
...
**Deflect Weapons**  
*prerequisite: Level 4*  
When hit by a weapon attack, you can spend 2 spell points and your reaction to reduce the damage by 1d10 + WIS + Weaver Level. Then if damage is reduced to zero, you can make one melee weapon attack against the attacking creature.  

**Destructive Burst**  
*prerequisite: Level 10*  
As an action, you can spend 5 spell points and choose a point within 60 feet that you can see. Each creature in a 10 foot radius of that point must make a Strength saving throw. On a failure a creature takes 4d6 Thunder damage and is pushed 10 feet away from the point. A creature that succeeds takes half damage and isn't pushed back. If the spell is centered on a creature, that creature has to make a Constitution saving throw or take 4d8 thunder damage instead, and is stunned for a round. On a success that creature takes half damage and isn't stunned.  

**End Affliction**  
*prerequisite: Level 6*  
As an action you can spend 1 spell point to end one effect on yourself that is causing you to be frightened.  
